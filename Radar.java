...
void serialEvent(Serial myPort){
    data=myPort.readStringUntil('.');data=data.substring(0,data.length()-1);index1=data.indexOf(",");angle=data.substring(0,index1);distance=data.substring(index1+1,data.length());iAngle=int(angle);iDistance=int(distance);
}
...
void drawText() {
    ...
    textSize(40);
    text("Minor-1 Ultrasonic Radar ", width - width * 0.875, height - height * 0.0277);
